...
通过 [GitHub Issues](https://github.com/helloo1568/image-ppt/issues) 提供：
...
- **Bugs:** open an [issue](https://github.com/helloo1568/image-ppt/issues) with your agent, OS, Python and skill versions, workflow stage, reproduction steps, expected/actual behavior, and a minimal sanitized example.
